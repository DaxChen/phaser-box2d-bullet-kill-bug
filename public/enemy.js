...
class Enemy extends Phaser.Sprite {
  constructor (game) {
    ...
    this.body.setCollisionCategory(game.CATEGORY_ENEMY)
  ...
  updateTarget () {
    this.target = this.game.player // TODO find closest player when doing multiplayer
  }
...
class EnemyGroup extends Phaser.Group {
  constructor (game) {
    super(game, game.world, 'Enemy Group', false, true/* , Phaser.Physics.BOX2D */)
